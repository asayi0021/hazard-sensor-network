...
This repository contains firmware code for both the sensor node and the repeater. Firmware is written for the RAK4630 module (attached to the RAK19007 baseboard), which houses a Nordic nRF52840 MCU and a Semtech SX1262 LoRa® transceiver, and the sensor hardware, which includes: SOME_SENSOR (Function A), SOME_SENSOR (Function B) and SOME_SENSOR (Function C). The repeater is also meant to intergrate into a network using the MeshCore platform.
